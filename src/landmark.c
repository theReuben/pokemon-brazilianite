...
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("RESERVE ENTRANCE"), -1};
...
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("SCAM PILLAR"), FLAG_LANDMARK_SKY_PILLAR};
