...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("ALGORITHM");
const u8 gText_ExpandedPlaceholder_Magma[] = _("BLOCKCHAIN");
const u8 gText_ExpandedPlaceholder_Archie[] = _("JULIAN");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("JULIAN");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("KYOGRE");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("GROUDON");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("JAKE");
const u8 gText_ExpandedPlaceholder_May[] = _("JAKE");
