...
// Generated by dev_scripts/regional_dex_gen.py from rom_hack_docs/regional_dex.md.
...
{
    // Species outside the dex convert to 0, not to a number past the end.
    return SpeciesToKantoPokedexNum(species) != 0;
}

bool32 IsSpeciesInHoennDex(u16 species)
{
    // Species outside the dex convert to 0, not to a number past the end.
    return SpeciesToHoennPokedexNum(species) != 0;
}
