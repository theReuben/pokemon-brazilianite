...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM ALGORITHM") },
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM BLOCKCHAIN") },
