...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM ALGO") },
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM BLCKCHN") },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("ALGO ADMIN"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("ALGO LEADER"), 20, BALL_MASTER },
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("CHAIN ADMIN"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("CHAIN LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_TEAM_ALGORITHM] = { _("TEAM ALGO") },
    [TRAINER_CLASS_ALGORITHM_ADMIN] = { _("ALGO ADMIN"), 10 },
    [TRAINER_CLASS_ALGORITHM_LEADER] = { _("ALGO LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_TEAM_BLOCKCHAIN] = { _("TEAM BLCKCHN") },
    [TRAINER_CLASS_BLOCKCHAIN_ADMIN] = { _("CHAIN ADMIN"), 10 },
    [TRAINER_CLASS_BLOCKCHAIN_LEADER] = { _("CHAIN LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_WEIRDO] = { _("WEIRDO"), 8 },
    [TRAINER_CLASS_MAGE] = { _("MAGE"), 6 },
    [TRAINER_CLASS_JJK] = { _("JJK"), 4 },
    [TRAINER_CLASS_CHAINSAW_MAN] = { _("CHAINSAW MAN"), 4 },
    [TRAINER_CLASS_SLIME] = { _("SLIME"), 15 },
...
static void HandleEndTurn_BattleWon(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER && !(gBattleTypeFlags & BATTLE_TYPE_LINK))
    {
        ...
        case TRAINER_CLASS_TEAM_ALGORITHM:
        case TRAINER_CLASS_ALGORITHM_ADMIN:
        case TRAINER_CLASS_ALGORITHM_LEADER:
        case TRAINER_CLASS_TEAM_BLOCKCHAIN:
        case TRAINER_CLASS_BLOCKCHAIN_ADMIN:
        case TRAINER_CLASS_BLOCKCHAIN_LEADER:
