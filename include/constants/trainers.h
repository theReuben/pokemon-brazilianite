...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_GALACTIC_COMMANDER_MARS,
    TRAINER_PIC_FRONT_GALACTIC_COMMANDER_JUPITER,
    TRAINER_PIC_FRONT_GALACTIC_COMMANDER_SATURN,
    TRAINER_PIC_FRONT_GALACTIC_LEADER_CYRUS,
    TRAINER_PIC_FRONT_ALGORITHM_GRUNT_M,
    TRAINER_PIC_FRONT_ALGORITHM_GRUNT_F,
    TRAINER_PIC_FRONT_ALGORITHM_ADMIN_M,
    TRAINER_PIC_FRONT_ALGORITHM_ADMIN_F,
    TRAINER_PIC_FRONT_ALGORITHM_LEADER_JULIAN,
    TRAINER_PIC_FRONT_BLOCKCHAIN_GRUNT_M,
    TRAINER_PIC_FRONT_BLOCKCHAIN_GRUNT_F,
    TRAINER_PIC_FRONT_BLOCKCHAIN_ADMIN,
    TRAINER_PIC_FRONT_BLOCKCHAIN_LEADER_JULIAN,
    TRAINER_PIC_FRONT_HISOKA,
    TRAINER_PIC_FRONT_LUFFY,
    TRAINER_PIC_FRONT_FRIEREN,
    TRAINER_PIC_FRONT_LIL_JON,
    TRAINER_PIC_FRONT_GRIMER,
    TRAINER_PIC_FRONT_YUJI,
    TRAINER_PIC_FRONT_DENJI,
    TRAINER_PIC_FRONT_PRAESTA,
    TRAINER_PIC_FRONT_HUSH,
...
#define FACILITY_CLASS_GALACTIC_GRUNT_M      0x77
#define FACILITY_CLASS_GALACTIC_GRUNT_F      0x78
#define FACILITY_CLASS_GALACTIC_COMMANDER_MARS    0x79
#define FACILITY_CLASS_GALACTIC_COMMANDER_JUPITER 0x7A
#define FACILITY_CLASS_GALACTIC_COMMANDER_SATURN  0x7B
#define FACILITY_CLASS_GALACTIC_LEADER_CYRUS 0x7C

#define FACILITY_CLASSES_COUNT               0x7D
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TEAM_ALGORITHM,
    TRAINER_CLASS_ALGORITHM_ADMIN,
    TRAINER_CLASS_ALGORITHM_LEADER,
    TRAINER_CLASS_TEAM_BLOCKCHAIN,
    TRAINER_CLASS_BLOCKCHAIN_ADMIN,
    TRAINER_CLASS_BLOCKCHAIN_LEADER,
    TRAINER_CLASS_LASS,
    ...
    TRAINER_CLASS_WEIRDO,
    TRAINER_CLASS_MAGE,
    TRAINER_CLASS_JJK,
    TRAINER_CLASS_CHAINSAW_MAN,
    TRAINER_CLASS_SLIME,
