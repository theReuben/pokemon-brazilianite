...
#define FLAG_DEFEATED_MAGMA_SPACE_CENTER     0x75 // Set when Team Blockchain is defeated at Mossdeep's Space Center.
...
#define FLAG_ITEM_NEW_MAUVILLE_ROTOM_CATALOG                        0x493
