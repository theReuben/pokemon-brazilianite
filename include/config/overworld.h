...
#define OW_HM_WITHOUT_MON               TRUE       // If enabled, an HM field move only requires the matching Badge - no party Pokemon needs to know the move. Fly is governed separately by OW_FLAG_POKE_RIDER.
