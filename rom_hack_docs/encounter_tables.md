...
|----------|-------------|---------|------|--------|
|Bidoof    |Normal       |Grass    |2-4   |Common  |
|Fletchling|Normal/Flying|Grass    |2-4   |Common  |
|Ledyba    |Bug/Flying   |Grass    |2-4   |Common  |
|Nymble    |Bug          |Grass    |2-4   |Uncommon|
|Meowth    |Normal       |Grass    |2-4   |Uncommon|
...
|Pokemon       |Type         |Encounter|Levels|Rarity  |
|--------------|-------------|---------|------|--------|
|Smoliv        |Grass/Normal |Grass    |3-5   |Common  |
|Tarountula    |Bug          |Grass    |3-5   |Common  |
|Pikipek       |Normal/Flying|Grass    |3-5   |Common  |
|Paldean Wooper|Poison/Ground|Grass    |3-5   |Uncommon|
|Poliwag       |Water        |Fishing  |3-5   |Uncommon|
...
|Pokemon      |Type |Encounter|Levels|Rarity  |
|-------------|-----|---------|------|--------|
|Snubbull     |Fairy|Grass    |4-6   |Common  |
|Alolan Meowth|Dark |Grass    |4-6   |Uncommon|
|Blipbug      |Bug  |Grass    |4-6   |Common  |
...
|Pokemon  |Type      |Encounter      |Levels|Rarity  |
|---------|----------|---------------|------|--------|
|Bounsweet|Grass     |Grass          |5-8   |Common  |
|Combee   |Bug/Flying|Grass          |5-8   |Common  |
|Teddiursa|Normal    |Grass          |5-8   |Uncommon|
|Dewpider |Water/Bug |Surf/Tall Grass|5-8   |Rare    |
...
|Pokemon            |Type          |Encounter |Levels|Rarity  |
|-------------------|--------------|----------|------|--------|
|Alolan Geodude     |Rock/Electric |Grass/Cave|8-11  |Common  |
|Nosepass           |Rock          |Grass/Cave|8-11  |Uncommon|
|Galarian Farfetch'd|Fighting      |Grass     |8-11  |Uncommon|
|Hisuian Voltorb    |Electric/Grass|Grass     |9-11  |Rare    |
|Galarian Meowth    |Steel         |Grass     |8-10  |Uncommon|
...
|Pokemon        |Type        |Encounter|Levels|Rarity  |
|---------------|------------|---------|------|--------|
|Timburr        |Fighting    |Cave     |8-12  |Common  |
|Solosis        |Psychic     |Cave     |8-11  |Uncommon|
|Drifloon       |Ghost/Flying|Cave     |9-12  |Uncommon|
|Galarian Yamask|Ground/Ghost|Cave     |9-12  |Rare    |
|Elekid         |Electric    |Cave     |8-11  |Rare    |
...
|Pokemon |Type         |Encounter|Levels|Rarity  |
|--------|-------------|---------|------|--------|
|Bibarel |Normal/Water |Grass    |16-19 |Common  |
|Ledian  |Bug/Flying   |Grass    |16-18 |Common  |
|Trumbeak|Normal/Flying|Grass    |16-19 |Uncommon|
|Spidops |Bug          |Grass    |16-18 |Uncommon|
...
|Pokemon        |Type         |Encounter |Levels|Rarity  |
|---------------|-------------|----------|------|--------|
|Hippopotas     |Ground       |Grass/Sand|22-26 |Common  |
|Hippowdon      |Ground       |Grass/Sand|24-26 |Rare    |
|Klawf          |Rock         |Grass     |22-25 |Uncommon|
|Orthworm       |Steel        |Grass/Sand|23-26 |Uncommon|
|Alolan Graveler|Rock/Electric|Grass/Cave|22-25 |Uncommon|
...
|Pokemon      |Type       |Encounter|Levels|Rarity  |
|-------------|-----------|---------|------|--------|
|Magby        |Fire       |Grass    |20-24 |Uncommon|
|Alolan Grimer|Poison/Dark|Grass    |20-24 |Common  |
|Simisear     |Fire       |Grass    |22-24 |Rare    |
|Glimmet      |Rock/Poison|Cave     |20-24 |Rare    |
...
|Dottler          |Bug/Psychic|Grass       |21-24 |Uncommon|
...
|Pokemon  |Type     |Encounter   |Levels|Rarity  |
|---------|---------|------------|------|--------|
|Spheal   |Ice/Water|Grass/Surf  |22-27 |Common  |
|Poliwhirl|Water    |Surf/Fishing|23-27 |Uncommon|
|Gurdurr  |Fighting |Grass       |23-27 |Uncommon|
|Clobbopus|Fighting |Grass/Surf  |22-25 |Uncommon|
...
|Pokemon         |Type       |Encounter      |Levels|Rarity  |
|----------------|-----------|---------------|------|--------|
|Hisuian Qwilfish|Dark/Poison|Surf           |27-31 |Uncommon|
|Binacle         |Rock/Water |Surf/Rock Smash|27-30 |Common  |
|Simisage        |Grass      |Grass          |28-31 |Rare    |
|Simipour        |Water      |Surf           |28-31 |Rare    |
|Granbull        |Fairy      |Grass          |27-30 |Uncommon|
...
|Pokemon    |Type        |Encounter|Levels|Rarity  |
|-----------|------------|---------|------|--------|
|Electabuzz |Electric    |Grass    |28-32 |Uncommon|
|Charjabug  |Bug/Electric|Grass    |28-31 |Common  |
|Duosion    |Psychic     |Grass    |29-32 |Uncommon|
|Persian    |Normal      |Grass    |29-32 |Uncommon|
|Fletchinder|Fire/Flying |Grass    |28-31 |Common  |
...
|Pokemon |Type  |Encounter    |Level|Notes                        |
|--------|------|-------------|-----|-----------------------------|
|Castform|Normal|Gift (Static)|25   |One-time gift from researcher|
...
|Pokemon          |Type          |Encounter|Levels|Rarity  |
|-----------------|--------------|---------|------|--------|
|Vikavolt         |Bug/Electric  |Grass    |31-35 |Rare    |
|Hisuian Electrode|Electric/Grass|Grass    |32-35 |Rare    |
|Perrserker       |Steel         |Grass    |31-34 |Uncommon|
|Drifblim         |Ghost/Flying  |Grass    |31-35 |Uncommon|
|Yanma            |Bug/Flying    |Grass    |31-34 |Common  |
...
|Pokemon  |Type       |Encounter|Levels|Rarity  |
|---------|-----------|---------|------|--------|
|Honchkrow|Dark/Flying|Grass    |33-37 |Uncommon|
|Tsareena |Grass      |Grass    |33-37 |Uncommon|
|Vanillish|Ice        |Grass    |33-36 |Uncommon|
...
|Pokemon         |Type          |Encounter       |Levels|Rarity  |
|----------------|--------------|----------------|------|--------|
|Runerigus       |Ground/Ghost  |Grass (Mt. Pyre)|34-38 |Rare    |
|Galarian Slowbro|Poison/Psychic|Surf            |34-38 |Uncommon|
|Alolan Persian  |Dark          |Grass (Mt. Pyre)|35-38 |Uncommon|
|Meowstic        |Psychic       |Grass (Mt. Pyre)|34-37 |Uncommon|
|Probopass       |Rock/Steel    |Cave            |35-38 |Rare    |
...
|Pokemon          |Type          |Encounter|Levels|Rarity  |
|-----------------|--------------|---------|------|--------|
|Galarian Slowking|Poison/Psychic|Surf     |35-40 |Rare    |
|Sealeo           |Ice/Water     |Surf     |35-40 |Uncommon|
|Grapploct        |Fighting      |Surf     |35-39 |Uncommon|
...
|Pokemon   |Type    |Encounter     |Levels|Rarity|
|----------|--------|--------------|------|------|
|Reuniclus |Psychic |Surf/Dive     |36-41 |Rare  |
|Electivire|Electric|Grass (island)|37-41 |Rare  |
|Politoed  |Water   |Surf          |36-41 |Rare  |
...
|Pokemon  |Type       |Encounter     |Levels|Rarity|
|---------|-----------|--------------|------|------|
|Glimmora |Rock/Poison|Surf/Dive     |37-42 |Rare  |
|Magmortar|Fire       |Grass (island)|38-42 |Rare  |
|Walrein  |Ice/Water  |Surf          |37-42 |Rare  |
...
|Pokemon   |Type       |Encounter     |Levels|Rarity|
|----------|-----------|--------------|------|------|
|Talonflame|Fire/Flying|Grass (island)|38-43 |Rare  |
|Yanmega   |Bug/Flying |Grass (island)|39-43 |Rare  |
|Vanilluxe |Ice        |Surf          |38-43 |Rare  |
|Orbeetle  |Bug/Psychic|Grass (island)|39-43 |Rare  |
...
|Pokemon |Type          |Encounter     |Levels|Rarity  |
|--------|--------------|--------------|------|--------|
|Noivern |Flying/Dragon |Grass (island)|39-44 |Rare    |
|Rotom   |Electric/Ghost|Grass (island)|39-44 |Rare    |
|Clodsire|Poison/Ground |Surf          |39-44 |Uncommon|
...
|Pokemon     |Type          |Encounter|Levels|Rarity   |
|------------|--------------|---------|------|---------|
|Ursaluna    |Ground/Normal |Cave     |42-50 |Rare     |
|Roaring Moon|Dragon/Dark   |Cave     |45-50 |Very Rare|
|Iron Valiant|Fairy/Fighting|Cave     |45-50 |Very Rare|
|Gholdengo   |Steel/Ghost   |Cave     |42-48 |Very Rare|
