...
|----------|-------------|---------|------|----|
|Bidoof    |Normal       |Grass    |2-4   |20% |
|Fletchling|Normal/Flying|Grass    |2-4   |20% |
|Ledyba    |Bug/Flying   |Grass    |2-4   |20% |
|Nymble    |Bug          |Grass    |2-4   |10% |
|Meowth    |Normal       |Grass    |2-4   |10% |
...
|Pokemon       |Type         |Encounter|Levels|Rate|
|--------------|-------------|---------|------|----|
|Smoliv        |Grass/Normal |Grass    |3-5   |20% |
|Tarountula    |Bug          |Grass    |3-5   |20% |
|Pikipek       |Normal/Flying|Grass    |3-5   |20% |
|Paldean Wooper|Poison/Ground|Grass    |3-5   |10% |
|Poliwag       |Water        |Fishing  |3-5   |30% |
...
|Pokemon      |Type |Encounter|Levels|Rate|
|-------------|-----|---------|------|----|
|Snubbull     |Fairy|Grass    |4-6   |20% |
|Alolan Meowth|Dark |Grass    |4-6   |10% |
|Blipbug      |Bug  |Grass    |4-6   |20% |
...
|Pokemon  |Type      |Encounter      |Levels|Rate|
|---------|----------|---------------|------|----|
|Bounsweet|Grass     |Grass          |5-8   |20% |
|Combee   |Bug/Flying|Grass          |5-8   |20% |
|Teddiursa|Normal    |Grass          |5-8   |10% |
|Dewpider |Water/Bug |Surf/Tall Grass|5-8   |5%  |
...
|Pokemon   |Type           |Encounter|Levels|Rate|
|----------|---------------|---------|------|----|
|Grubbin   |Bug            |Grass    |6-9   |20% |
|Tarountula|Bug            |Grass    |6-9   |20% |
|Murkrow   |Dark/Flying    |Grass    |6-9   |10% |
|Noibat    |Flying/Dragon  |Grass    |6-9   |10% |
|Toxel     |Electric/Poison|Grass    |7-9   |5%  |
...
|Pokemon            |Type          |Encounter |Levels|Rate|
|-------------------|--------------|----------|------|----|
|Alolan Geodude     |Rock/Electric |Grass/Cave|8-11  |20% |
|Nosepass           |Rock          |Grass/Cave|8-11  |10% |
|Galarian Farfetch'd|Fighting      |Grass     |8-11  |10% |
|Hisuian Voltorb    |Electric/Grass|Grass     |9-11  |5%  |
|Galarian Meowth    |Steel         |Grass     |8-10  |10% |
...
|Pokemon        |Type        |Encounter|Levels|Rate|
|---------------|------------|---------|------|----|
|Timburr        |Fighting    |Cave     |8-12  |20% |
|Solosis        |Psychic     |Cave     |8-11  |10% |
|Drifloon       |Ghost/Flying|Cave     |9-12  |10% |
|Galarian Yamask|Ground/Ghost|Cave     |9-12  |5%  |
|Elekid         |Electric    |Cave     |8-11  |5%  |
...
|Pokemon |Type         |Encounter|Levels|Rate|
|--------|-------------|---------|------|----|
|Bibarel |Normal/Water |Grass    |16-19 |20% |
|Ledian  |Bug/Flying   |Grass    |16-18 |20% |
|Trumbeak|Normal/Flying|Grass    |16-19 |10% |
|Spidops |Bug          |Grass    |16-18 |10% |
...
|Pokemon|Type        |Encounter|Levels|Rate|
|-------|------------|---------|------|----|
|Pansage|Grass       |Grass    |17-20 |10% |
|Pansear|Fire        |Grass    |17-20 |10% |
|Panpour|Water       |Grass    |17-20 |10% |
|Steenee|Grass       |Grass    |17-20 |20% |
|Dolliv |Grass/Normal|Grass    |17-20 |10% |
...
|Pokemon        |Type         |Encounter |Levels|Rate|
|---------------|-------------|----------|------|----|
|Hippopotas     |Ground       |Grass/Sand|22-26 |20% |
|Hippowdon      |Ground       |Grass/Sand|24-26 |5%  |
|Klawf          |Rock         |Grass     |22-25 |10% |
|Orthworm       |Steel        |Grass/Sand|23-26 |10% |
|Alolan Graveler|Rock/Electric|Grass/Cave|22-25 |10% |
...
|Pokemon      |Type       |Encounter|Levels|Rate|
|-------------|-----------|---------|------|----|
|Magby        |Fire       |Grass    |20-24 |10% |
|Alolan Grimer|Poison/Dark|Grass    |20-24 |20% |
|Simisear     |Fire       |Grass    |22-24 |5%  |
|Glimmet      |Rock/Poison|Cave     |20-24 |5%  |
...
|Pokemon          |Type       |Encounter   |Levels|Rate|
|-----------------|-----------|------------|------|----|
|Espurr           |Psychic    |Grass       |21-25 |20% |
|Magmar           |Fire       |Grass       |22-25 |10% |
|Galarian Slowpoke|Psychic    |Grass       |21-25 |10% |
|Gimmighoul       |Ghost      |Grass/Hidden|23-25 |5%  |
|Dottler          |Bug/Psychic|Grass       |21-24 |10% |
...
|Pokemon  |Type     |Encounter   |Levels|Rate|
|---------|---------|------------|------|----|
|Spheal   |Ice/Water|Grass/Surf  |22-27 |20% |
|Poliwhirl|Water    |Surf/Fishing|23-27 |30% |
|Gurdurr  |Fighting |Grass       |23-27 |10% |
|Clobbopus|Fighting |Grass/Surf  |22-25 |10% |
...
|Pokemon         |Type       |Encounter      |Levels|Rate|
|----------------|-----------|---------------|------|----|
|Hisuian Qwilfish|Dark/Poison|Surf           |27-31 |30% |
|Binacle         |Rock/Water |Surf/Rock Smash|27-30 |60% |
|Simisage        |Grass      |Grass          |28-31 |5%  |
|Simipour        |Water      |Surf           |28-31 |5%  |
|Granbull        |Fairy      |Grass          |27-30 |10% |
...
|Pokemon    |Type        |Encounter|Levels|Rate|
|-----------|------------|---------|------|----|
|Electabuzz |Electric    |Grass    |28-32 |10% |
|Charjabug  |Bug/Electric|Grass    |28-31 |20% |
|Duosion    |Psychic     |Grass    |29-32 |10% |
|Persian    |Normal      |Grass    |29-32 |10% |
|Fletchinder|Fire/Flying |Grass    |28-31 |20% |
...
|Pokemon   |Type           |Encounter|Levels|Rate|
|----------|---------------|---------|------|----|
|Tropius   |Grass/Flying   |Grass    |30-34 |5%  |
|Ursaring  |Normal         |Grass    |30-34 |10% |
|Toxtricity|Electric/Poison|Grass    |31-34 |5%  |
|Lokix     |Bug/Dark       |Grass    |30-33 |10% |
|Vespiquen |Bug/Flying     |Grass    |31-34 |5%  |
|Feebas    |Water          |Fishing  |30-33 |5%  |
...
|Pokemon          |Type          |Encounter|Levels|Rate|
|-----------------|--------------|---------|------|----|
|Vikavolt         |Bug/Electric  |Grass    |31-35 |5%  |
|Hisuian Electrode|Electric/Grass|Grass    |32-35 |5%  |
|Perrserker       |Steel         |Grass    |31-34 |10% |
|Drifblim         |Ghost/Flying  |Grass    |31-35 |10% |
|Yanma            |Bug/Flying    |Grass    |31-34 |20% |
...
|Pokemon  |Type       |Encounter|Levels|Rate|
|---------|-----------|---------|------|----|
|Honchkrow|Dark/Flying|Grass    |33-37 |10% |
|Tsareena |Grass      |Grass    |33-37 |10% |
|Vanillish|Ice        |Grass    |33-36 |10% |
...
|Pokemon         |Type          |Encounter       |Levels|Rate|
|----------------|--------------|----------------|------|----|
|Runerigus       |Ground/Ghost  |Grass (Mt. Pyre)|34-38 |5%  |
|Galarian Slowbro|Poison/Psychic|Surf            |34-38 |30% |
|Alolan Persian  |Dark          |Grass (Mt. Pyre)|35-38 |10% |
|Meowstic        |Psychic       |Grass (Mt. Pyre)|34-37 |10% |
|Probopass       |Rock/Steel    |Cave            |35-38 |5%  |
...
|Pokemon         |Type         |Encounter|Levels|Rate|
|----------------|-------------|---------|------|----|
|Alolan Muk      |Poison/Dark  |Grass    |33-37 |10% |
|Sirfetch'd      |Fighting     |Grass    |34-37 |5%  |
|Arboliva        |Grass/Normal |Grass    |33-37 |10% |
|Toucannon       |Normal/Flying|Grass    |33-36 |10% |
|Hisuian Basculin|Water        |Surf     |33-37 |30% |
...
|Pokemon     |Type          |Encounter|Levels|Rate|
|------------|--------------|---------|------|----|
|Ursaluna    |Ground/Normal |Cave     |42-50 |5%  |
|Roaring Moon|Dragon/Dark   |Cave     |45-50 |1%  |
|Iron Valiant|Fairy/Fighting|Cave     |45-50 |1%  |
|Gholdengo   |Steel/Ghost   |Cave     |42-48 |1%  |
